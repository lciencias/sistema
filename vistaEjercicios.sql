...
proyecto.idproyecto as idproyecto, proyecto.nombre as proyecto,  DATE_FORMAT(proyecto.fecha_fin, "%d-%m-%Y") as fecha_fin, DATEDIFF("2019-11-23 23:15:10",proyecto.fecha_fin) as dias,
