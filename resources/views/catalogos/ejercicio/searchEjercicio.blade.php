{!! Form::open(array('url'=>'seguridad/ejercicio','method'=>'GET','autocomplete'=>'off','role'=>'search')) !!}
<?php 
$tmp1 = $tmp2 = $tmp3 = "";
if($activo == 1){
	$tmp1 = "selected ";
...
<div class="form-group">
	<div class="row">
		<div class="col-md-4"> 
			<input type="text" class="form-control inputText" name="searchText" placeholder="Buscar por ejercicio" value="{{$searchText}}" >
		</div> 
		@if($isAdmin == 1)
		<div class="col-md-4"> 
	...
	<div class="row">	
    	<div class="col-md-12 tdRight"> <br/>
			...
			@if (in_array('Crear',$sessionPermisos))
				 <a href="ejercicio/create" class="btn btn-success  btn-sm">
