    	...
    	<div class="modal-dialog" style="width: 85%">
    		...
    		<div class="modal-content">
    			<div class="modal-header">
                    <h4 class="modal-title">{{Lang::get('leyendas.prueba.agregaComportamiento')}}</h4>
    			</div>
    			<div class="modal-body">
    				<div class="row">
                    	<div  class="col-md-12">	
                    		<div class="form-group">
                    			<label for="nombreComportamiento" class="control-label">*{{Lang::get('leyendas.prueba.comportamiento')}}</label> 
