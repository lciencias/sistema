...
<div class="box box-solid">
    ...
    <h3 class="box-title" style="color:blue;font-weight:bold;">{{Lang::get('leyendas.candidato.experiencias')}}</h3>
	</div>
...
<div class="box box-solid">
    ...
    <h3 class="box-title" style="color:blue;font-weight:bold;">{{Lang::get('leyendas.candidato.intereses')}}</h3>
	</div>
